...
// Auto-generated page for: Design cost prediction across furniture, labor, materials wi

export default function CfDesignCostPredictionAcrossFurniture() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-design-cost-prediction-across-furniture-', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      ...
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Design cost prediction across furniture, labor, materials wi'}
        </button>
      </form>
