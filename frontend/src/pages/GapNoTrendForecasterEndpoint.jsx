...
// Auto-generated page for: No trend forecaster endpoint

export default function GapNoTrendForecasterEndpoint() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-trend-forecaster-endpoint', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No trend forecaster endpoint</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No trend forecaster endpoint</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No trend forecaster endpoint'}
        </button>
      </form>
