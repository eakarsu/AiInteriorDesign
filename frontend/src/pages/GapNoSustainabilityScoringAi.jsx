...
// Auto-generated page for: No sustainability scoring AI

export default function GapNoSustainabilityScoringAi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-sustainability-scoring-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No sustainability scoring AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No sustainability scoring AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No sustainability scoring AI'}
        </button>
      </form>
