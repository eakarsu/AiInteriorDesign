...
// Auto-generated page for: No file upload pipeline for floor-plan uploads

export default function GapNoFileUploadPipelineForFloor() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-file-upload-pipeline-for-floor', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No file upload pipeline for floor-plan uploads</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No file upload pipeline for floor-plan uploads</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No file upload pipeline for floor-plan uploads'}
        </button>
      </form>
