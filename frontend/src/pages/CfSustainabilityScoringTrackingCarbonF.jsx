...
// Auto-generated page for: Sustainability scoring tracking carbon footprint of material

export default function CfSustainabilityScoringTrackingCarbonF() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-sustainability-scoring-tracking-carbon-f', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Sustainability scoring tracking carbon footprint of material</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Sustainability scoring tracking carbon footprint of material choices.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Sustainability scoring tracking carbon footprint of material'}
        </button>
      </form>
